  ...
  switch (action?.type) {
    ...
    case _types.GET_REQUEST_CARDIO_SESSION_LIST_SUCCESS:
      newState = {
        ...state,
        cardioSessionGetError: null,
        cardioSessionGetPayload: action.data
      };
      break;
    ...
    case _types.PUT_REQUEST_CARDIO_SESSION_ITEM_START:
      newState = {
        ...
        isProcessingCardioSession: true
      };
      break;
    case _types.PUT_REQUEST_CARDIO_SESSION_ITEM_SUCCESS:
      newState = {
        ...state,
        cardioSessionPutError: null,
        cardioSessionPutPayload: action.data
      };
      break;
    case _types.PUT_REQUEST_CARDIO_SESSION_ITEM_ERROR:
      newState = {
        ...state,
        cardioSessionPutError: action.error,
        cardioSessionPutPayload: null
      };
      break;
